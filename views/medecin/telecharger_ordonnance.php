...
$pdf->Cell(50, 7, 'Médicament', 1, 0, 'C', true);
$pdf->Cell(50, 7, 'Posologie', 1, 0, 'C', true);
$pdf->Cell(40, 7, 'Quantité', 1, 0, 'C', true);
$pdf->Cell(40, 7, 'Durée', 1, 1, 'C', true);
...
for ($i = 0; $i < $max; $i++) {
    $pdf->Cell(50, 7, isset($medicaments[$i]) ? $medicaments[$i] : '', 1, 0);
    $pdf->Cell(50, 7, isset($posologies[$i]) ? $posologies[$i] : '', 1, 0);
    $pdf->Cell(40, 7, isset($quantites[$i]) ? $quantites[$i] : '', 1, 0);
    $pdf->Cell(40, 7, isset($durees[$i]) ? $durees[$i] : '', 1, 1);
}
